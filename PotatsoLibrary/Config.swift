...
open class Config {
    ...
    open func setup(string configString: String) throws {
        guard !configString.isEmpty, let object = try? YAMLSerialization.object(withYAMLString: configString, options: kYAMLReadOptionStringScalars), let yaml = object as? [String: AnyObject] else {
